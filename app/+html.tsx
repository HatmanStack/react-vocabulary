...
const SITE_DESCRIPTION =
  "Build your vocabulary with 350 words across 18 themed lists. Interactive quizzes, progress tracking, achievements, and cloud sync. Free vocabulary builder for all ages.";
  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta
          name="keywords"
          content="vocabulary app, vocabulary builder, word learning, vocabulary quiz, learn new words, vocabulary practice, educational app, word games"
        />
              ...
              mainEntity: [
                {
                  ...
                  acceptedAnswer: {
                    "@type": "Answer",
                    text: "From the home screen, select a vocabulary list. Then choose a difficulty level. The quiz will start automatically.",
                  },
                },
                {
                  "@type": "Question",
