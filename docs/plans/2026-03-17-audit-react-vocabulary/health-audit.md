...
4. **[Structural Debt]** `src/shared/store/progressStore.ts:1-738`
...
5. **[Architectural Debt]** `src/shared/store/progressStore.ts:620-624` and `693-704`
...
6. **[Architectural Debt]** `src/shared/store/vocabularyStore.ts:124`
...
7. **[Operational Debt]** `src/shared/store/progressStore.ts:176-199`
...
8. **[Structural Debt]** `src/features/settings/utils/progressExport.ts:128-148`
...
10. **[Code Hygiene]** `src/features/vocabulary/screens/HomeScreen.tsx:23,27`
...
11. **[Structural Debt]** `src/features/quiz/screens/QuizScreen.tsx:60-83` and `128-155`
...
12. **[Code Hygiene]** `src/features/settings/utils/progressExport.ts:16`
...
13. **[Operational Debt]** `src/shared/store/progressStore.ts:217`
...
14. **[Code Hygiene]** Multiple files (12 instances)
...
15. **[Structural Debt]** `src/shared/store/quizStore.ts:64-120` and `src/shared/store/progressStore.ts:241-303`
...
16. **[Operational Debt]** `src/shared/store/quizStore.ts:180-224`
...
17. **[Code Hygiene]** `src/shared/ui/ErrorBoundary.tsx:112-118`
...
18. **[Code Hygiene]** `package.json` (knip scan results)
...
19. **[Code Hygiene]** `package.json` (npm audit results)
...
20. **[Code Hygiene]** knip scan: 12 unused files
...
21. **[Code Hygiene]** knip scan: 14 unused exports + 13 unused exported types
...
22. **[Structural Debt]** `backend/src/types.ts` and `src/shared/types/progress.ts`
...
23. **[Structural Debt]** `src/shared/store/progressStore.ts:507-513` and `src/features/progress/utils/achievements.ts:9-19`
...
24. **[Code Hygiene]** `src/shared/ui/Typography.tsx:82`
