...
export function isValidProgressData(data: unknown): data is Partial<UserProgress> {
  ...
  if (d.listLevelProgress !== undefined && typeof d.listLevelProgress !== 'object') return false;
  if (d.globalStats !== undefined && typeof d.globalStats !== 'object') return false;
  return true;
}
...
export function isValidProgressExportData(data: unknown): boolean {
  ...
  if (inner.listLevelProgress !== undefined && typeof inner.listLevelProgress !== 'object') return false;
  if (inner.globalStats !== undefined && typeof inner.globalStats !== 'object') return false;
  return true;
}
